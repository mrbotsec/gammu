...
<?php//this script was created by Michal Holes (michal@holes.sk)
...
$result = sql("SELECT * FROM inbox $If ORDER BY ReceivingDateTime"); //select data with variable and order it by time and date of the reception
